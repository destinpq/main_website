...
export const metadata: Metadata = {
  title: "Privacy Policy | DestinPQ",
  description: "Privacy policy for DestinPQ services",
};
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose max-w-none">
        ...
        <p>This Privacy Policy describes how DESTINPQ LLP and its affiliates (collectively "DESTINPQ LLP, we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website www.destinpq.com (hereinafter referred to as Platform). Please note that you may be able to browse certain sections of the Platform without registering with us.</p>
        ...
        <p>If you receive an email, a call from a person/association claiming to be DESTINPQ LLP seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.</p>
