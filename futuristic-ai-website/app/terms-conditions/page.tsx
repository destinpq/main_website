...
export const metadata: Metadata = {
  title: "Terms & Conditions | DestinPQ",
  description: "Terms and conditions for using DestinPQ's services.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose max-w-none">
        ...
        <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.destinpq.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
        
        <p>The Platform is owned by DESTINPQ LLP, a company incorporated under the Companies Act, 1956 with its registered office at Gulzar Hauz, CHARKAMAN, Charminar, Hyderabad (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</p>
        ...
        <p className="font-bold">ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</p>
