...
export default function Footer() {
  return (
    <footer className="bg-black text-gray-500 p-8 border-t border-gray-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center mb-4">
            <div className="relative mr-3 w-[40px] h-[40px]">
              {/* Outer yellow glow */}
            ...
            <div className="text-xl font-bold bg-gradient-to-r from-yellow-400 to-amber-500 text-transparent bg-clip-text">
              DESTINPQ
            </div>
          </div>
          <p className="text-sm text-gray-400 max-w-xs">
            DestinPQ is a cutting-edge platform that leverages AI and machine learning to provide innovative solutions for businesses.
          </p>
        </div>
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#case-studies" className="hover:text-yellow-400 transition-colors">Case Studies</a></li>
            <li><a href="#technology" className="hover:text-yellow-400 transition-colors">Technology</a></li>
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link href="/terms-conditions" className="hover:text-yellow-400 transition-colors">
                Terms & Conditions
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/refund-cancellation-policy" className="hover:text-yellow-400 transition-colors">
      ...
      <div className="border-t border-gray-800 mt-8 pt-6 text-center text-sm">
        <p>© {new Date().getFullYear()} DestinPQ LLP. All rights reserved.</p>
      </div>
    </footer>
  );
} 